...
function ProductDetails() {
  const { currency, products, navigate, addToCart } = useAppContext();
  const { id } = useParams();
          ...
          <div className="text-sm w-full md:w-1/2">
            ...
            <div className="flex items-center mt-10 gap-4 text-base">
              <button
                ...
                className="w-full py-3.5 cursor-pointer font-medium bg-gray-300 text-gray-800/80 hover:bg-gray-200 transition"
              >
                Add to Cart
              </button>
              <button
